...
const Register = () => {
  ...
  const errorMessage = formData.password !== formData.confirmPassword && formData.confirmPassword 
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-purple-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      ...
      >
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-600">Start creating amazing product tours</p>
        </div>
